...
func main() {
	...
	var class="travel"
	var url = "http://"+class+".fengniao.com/slide/535/5359737_1.html"
	var dir = util.GetNameIDFromUri(url)
	AnalyzeFrom(url,class, dir)
	WG.Wait()
}
func AnalyzeFrom(url string,class string, dir string) int {
